...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='remita.conf'
CONFIGFOLDER='/root/.remita'
COIN_DAEMON='remitad'
COIN_CLI='remita-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/Remitacoin/remit/releases/download/1.0.0/remita-1.0.0-linux.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='remitad'
COIN_EXPLORER='http://explorer.remitacoin.com'
COIN_PORT=8351
RPC_PORT=8352
